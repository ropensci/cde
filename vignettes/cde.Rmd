...
**MEASURES DATA ARE NO LONGER AVAILABLE**
...
Plotting the output of `get_measures` produces a frequency histogram of the `measure_category_1` column within the area specified. In this case, there is only one measure specified.

```{r lark measures plot,fig.height=4, fig.width=6.5, fig.align="center", eval=FALSE}
plot(lark_OC_meas)
```
