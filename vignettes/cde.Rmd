...
`cde` is a package for R which facilitates searching and download of the WFD reporting data for all waterbodies within the EA area.
...
#plot_status(ea_name="Lark", column="OC", startyr=2013, endyr=2015)
```
...
#plot_status(ea_name="Lark", column="OC", startyr=2015, type="River", scheme="wfd")
```
...
lark_OC_RNAG<-get_rnag(ea_name="Lark", column="OC", startyr=2013, endyr=2015)
```
