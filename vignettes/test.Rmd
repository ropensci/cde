...
vignette: >
  %\VignetteIndexEntry{cde-testing}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

## Reference list of columns output
...
business_sector | Categorisation of the business sector linked to the RNAG, for example "Transport", "Retail sector", "Forestry" | get_rnag
category | Broad categorisation of the RNAG, for example "Industry", "Agriculture and rural land management". | get_rnag
