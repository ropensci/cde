...
The text of the DESCRIPTION has been updated to not start 'The cde package...' and the code has been revised so that no changes are made to the 'par' settings of the user.
